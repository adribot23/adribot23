...
<p align="center">
  Actualmente en el cuarto año de Ingeniería de Software en la <b>Universidad Complutense de Madrid (UCM)</b> y desarrollando mi Trabajo de Fin de Grado (TFG) centrado en el análisis inteligente de logs en arquitecturas distribuidas. Disfruto construyendo aplicaciones completas, abarcando desde el frontend y el backend hasta el diseño complejo de la persistencia de datos, la administración de sistemas Linux y el despliegue en entornos cloud como Azure.
</p>
